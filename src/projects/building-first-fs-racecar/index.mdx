...
images:
  ...
  - ./images/image-test-2.jpg
  - ./images/image-test-3.jpg
  - ./images/image-test-4.jpg
  - ./images/image-compete-1.jpg
  - ./images/image-compete-2.jpg
  - ./images/image-compete-3.jpg
  - ./images/image-compete-4.jpg
  - ./images/image-compete-5.jpg
  - ./images/image-compete-6.jpg
  - ./images/image-compete-7.jpg
  - ./images/image-compete-8.jpg
...
Realizing the project scope and the competition, we then moved on to define the project goal.
...
<Carousel
  image={[
    ...
    {
      img: props.images[6],
      caption: `Early meeting @ Sep 2018`,
    },
    {
      img: props.images[7],
...
Frequent discussions kept everyone on the same page, and when there’s change or idea, it could be quickly implemented. Furthermore, it’s a must to understand why the modifications were needed and different subteams’ goals and constraints, almost always theirs were also one for frame in some way. In short, discuss the solutions, understand he needs.

<Carousel
  image={[
    {
      img: props.images[9],
      caption: `Sketch about overall vehicle`,
    },
    {
      img: props.images[10],
      caption: `Just some sketches`,
    },
    {
      img: props.images[11],
      caption: `Whole vehicle side view drawing`,
    },
    {
      img: props.images[12],
...
Also having a plan B is essential to make sure the development could continue with a backup even in the worst situation. (But better said than done, it’s more complicated than what we thought)
...
Before getting into the competition, teams have to submit a video of vehicle in operation, (Shakedown Certificate), in a way to make sure teams are ready for competition.
...
**At this time the problems usually showed up suddenly, we must learn to react quickly and address accordingly.** What we could do was trying to lower the chances and building a procedure to address similar problems.

<Carousel
  image={[
    {
      img: props.images[21],
      caption: `Vehicle transporting @ Jel 2019`,
    },
    {
      img: props.images[22],
      caption: `Shakedown certificate complete @ Aug 2019`,
    },
    {
      img: props.images[23],
      caption: `Final testing @ Aug 2019`,
    },
    {
      img: props.images[24],
      caption: `Final final test @ Aug 2019`,
    },
  ]}
/>
...
<InlineImage image={props.images[33]} />
...
<InlineImage image={props.images[34]} />
...
<InlineImage image={props.images[35]} />
...
It’s impossible to have these great achievements without teamwork, collaboration between members with different backgrounds
...
<CustomWidth image={props.images[36]} width={"60vw"}>
  Team Taiwan
</CustomWidth>
